...
public class NovelApiService {
    ...
    public async Task<List<string>?> GetTablesAsync() {
        ...
        return await _apiClient.GetAsync<List<string>>("/api/novel-extractor/tabelas");
    }
    ...
    /// <param name="volumes">A lista de objetos NovelVolumeDto a ser enviada.</param>
    /// <returns>Verdadeiro se o envio foi bem-sucedido.</returns>
    public async Task<bool> SendVolumesAsync(string tableName, List<NovelVolumeDto> volumes) {
    ...
    /// <param name="volumes">A lista de objetos NovelVolumeDto a ser deletado.</param>
    /// <returns>Verdadeiro se o delete foi bem-sucedido.</returns>
    public async Task<bool> DeleteVolumesAsync(string tableName, List<NovelVolumeDto> volumes) {
        if (volumes == null || !volumes.Any()) {
